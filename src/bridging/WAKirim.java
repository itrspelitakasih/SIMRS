...
/**
 * WAKirim.java - WA Gateway Fawwaz (http://172.22.10.134:3000) Kompatibel dengan
 * endpoint: - /api/sendtext - /api/sendmedia (via URL PDF)
 *
 * Penyesuaian dari versi WAHA agar semua fungsi tetap bekerja di WA Gateway
 * Fawwaz Author: Chandra Irawan M.T.I
 */
public class WAKirim {
    ...
    public static SendResult kirimTeksWithStatus(String nomorWA, String pesan) {
        ...
        try {
            ...
            String apiUrl = "http://172.22.10.134:3000/api/sendtext";
            ...
            if ((httpCode == 200 || httpCode == 201) && (result.responseBody.contains("Success")
    ...
    public static String uploadPDFToServer(File file) {
        ...
        final String WAHA_BASE_URL = "http://172.22.10.134:3000";
        final String AUTH_TOKEN = "SayangAnisaNairaNafasya";
    ...
    public static SendResult kirimMediaPDF(String nomorWA, String pesan, String fileUrl) {
        ...
        try {
            ...
            String apiUrl = "http://172.22.10.134:3000/api/sendmedia";
    ...
    public static void uploadPDFToServerWAHA(File file) {
        final String WAHA_URL = "https://waha.rspelitakasih.id";
        final String AUTH_TOKEN = "SayangAnisaNairaNafasya";
        try {
    ...
    public static String getUploadURL() {
        try {
            ...
            return prop.getProperty("UPLOADLABURL", UPLOAD_URL);
        } catch (Exception e) {
            return UPLOAD_URL;
        }
    }
